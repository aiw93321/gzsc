            ...
            <div class="col-lg-12">
                ...
                <div class="form-horizontal m-t m-b">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" name="mobile" class="form-control" placeholder="请输入手机~~" value="<?=$user['mobile']?>">
                        </div>
                    </div>
                    <div class="hr-line-dashed"></div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" name="login_name" class="form-control" autocomplete="off" placeholder="请输入登录名~~" value="<?=$user['nickname']?>">
                        </div>
                    </div>
                    <div class="hr-line-dashed"></div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-lg-4 col-lg-offset-2">
                            ...
                            <button class="btn btn-w-m btn-outline btn-primary save" onclick="account.set('<?=$user['uid']?>')">保存</button>
                        </div>
                    </div>
                </div>
            </div>
