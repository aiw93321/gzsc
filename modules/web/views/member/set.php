            ...
            <div class="col-lg-12">
                ...
                <div class="form-horizontal m-t">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" class="form-control" placeholder="请输入会员名称" name="nickname" value="<?=$list['nickname']?>">
                        </div>
                    </div>
                    <div class="hr-line-dashed"></div>
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" class="form-control" placeholder="请输入会员手机" name="mobile" value="<?=$list['mobile']?>">
                        </div>
                    </div>
                    <div class="hr-line-dashed"></div>
                    <div class="form-group">
                        <div class="col-lg-4 col-lg-offset-2">
                            ...
                            <button class="btn btn-w-m btn-outline btn-primary save" onclick="member.add()">保存</button>
                        </div>
                    </div>
                </div>
            </div>
